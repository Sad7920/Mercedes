...
const AddSession = ({ addSession }) => {
    ...
    return (
        <div className='grid grid-cols-5 mb-5 gap-x-2'>
            ...
            />
            <button className='col-span-1 w-full px-4 py-2 font-thin text-black bg-white border border-transparent rounded-sm text-sm focus:outline-none hover:border-b-4 border-b-4 border-white hover:border-b-[#00f5d0] hover:bg-neutral-200' onClick={handleAddSession}>Add</button>
        </div>
    );
};
